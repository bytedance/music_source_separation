...
if __name__ == '__main__':
    ...
    parser.add_argument('--audio_path', type=str, default="resources/vocals_accompaniment_10s.mp3", help="Audio path")
    parser.add_argument('--source_type', type=str, choices=['vocals', 'accompaniment'], default="accompaniment", help="Source type to be separated.")
