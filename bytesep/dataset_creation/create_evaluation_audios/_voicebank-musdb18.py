...
def create_evaluation(args):
    ...
    voicebank_dataset_dir = args.voicebank_dataset_dir
    ...
    speech_audios_dir = os.path.join(voicebank_dataset_dir, 'clean_{}set_wav'.format(split))
    speech_audio_names = sorted(os.listdir(speech_audios_dir))
